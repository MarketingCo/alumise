  ...
  return (
    <div className="bg-white min-h-screen">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-20">
            ...
            <div className="lg:col-span-2 space-y-12">
              <div className="space-y-6">
                <h2 className="text-sm font-bold uppercase tracking-[0.3em] text-brand-blue">Project Overview</h2>
      ...
      <section className="py-24 bg-gray-50 border-t border-gray-100">
        <div className="container mx-auto px-4 max-w-7xl">
          <h2 className="text-sm font-bold uppercase tracking-[0.3em] text-brand-blue mb-12">View More Work</h2>
              ...
              .map((p) => (
                ...
                >
                  ...
                  <div className="absolute inset-0 p-6 flex flex-col justify-end">
                    <h4 className="text-white font-bold uppercase tracking-tight text-sm group-hover:text-brand-blue transition-colors">{p.title}</h4>
                  </div>
                </Link>
              ))}
          </div>
