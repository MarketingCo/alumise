...
export default function ProjectCaseStudyContent({ slug }: { slug: string }) {
  ...
  return (
    <div className="bg-white min-h-screen">
      {/* Project Hero */}
      <section className="relative h-[80vh] min-h-[600px] flex items-end bg-brand-charcoal text-white overflow-hidden">
        <Image 
          src={project.image}
          alt={project.title}
          fill
        ...
        <div className="container mx-auto px-4 max-w-7xl relative z-10 pb-20">
          ...
          <div className="flex flex-wrap gap-4 mb-6">
            <span className="flex items-center text-[10px] uppercase tracking-[0.2em] font-bold text-brand-gold bg-white/5 backdrop-blur-md px-4 py-2 border border-white/10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-20">
            ...
            <div className="lg:col-span-2 space-y-12">
              <div className="space-y-6">
                <h2 className="text-sm font-bold uppercase tracking-[0.3em] text-brand-gold">Project Overview</h2>
                <p className="text-2xl text-brand-charcoal font-light leading-relaxed">
                  {project.description}
                </p>
              ...
              <div className="bg-white border border-gray-100 p-10 shadow-2xl">
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex justify-between items-center py-4 border-b border-gray-50">
                    ...
                    <span className="text-xs font-bold uppercase text-brand-gold">Completed</span>
                  </div>
                ...
                <Link 
                  href="/quote" 
                  className="mt-12 w-full bg-brand-charcoal text-white text-center block px-8 py-5 rounded-sm font-bold uppercase tracking-widest text-xs transition-all hover:bg-brand-gold shadow-xl"
                >
                  Discuss Similar Project
                </Link>
              </div>

              <div className="p-10 bg-brand-gold text-white">
      ...
      <section className="py-24 bg-gray-50 border-t border-gray-100">
        <div className="container mx-auto px-4 max-w-7xl">
          <h2 className="text-sm font-bold uppercase tracking-[0.3em] text-brand-gold mb-12">View More Work</h2>
            ...
            {projects
              ...
              .map((p) => (
                <Link 
                  ...
                  className="group block relative h-64 overflow-hidden bg-brand-charcoal"
                >
                  <Image 
                    src={p.image} 
                    alt={p.title} 
                  ...
                  <div className="absolute inset-0 p-6 flex flex-col justify-end">
                    <h4 className="text-white font-bold uppercase tracking-tight text-sm group-hover:text-brand-gold transition-colors">{p.title}</h4>
                  </div>
                </Link>
              ))}
          </div>
