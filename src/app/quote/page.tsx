    ...
    return (
      <div className="min-h-screen bg-brand-charcoal text-white flex items-center justify-center p-4">
        ...
        >
          ...
          <Link href="/" className="inline-block bg-brand-blue text-white px-10 py-4 rounded-sm font-bold uppercase tracking-widest text-xs">
            Return to Home
          </Link>
        </motion.div>
      </div>
        ...
        <form onSubmit={handleSubmit} className="bg-white border border-gray-100 shadow-2xl p-8 md:p-12 relative overflow-hidden">
          <AnimatePresence mode="wait">
            {step === 1 && (
              ...
              >
                <div>
                  <h3 className="text-sm font-bold uppercase tracking-[0.2em] text-brand-blue mb-6">01. Select System Category</h3>
                ...
                <div>
                  <h3 className="text-sm font-bold uppercase tracking-[0.2em] text-brand-blue mb-6">02. Project Sector</h3>
            ...
            {step === 2 && (
              ...
              >
                <div>
                  <h3 className="text-sm font-bold uppercase tracking-[0.2em] text-brand-blue mb-6">03. Material Preference</h3>
