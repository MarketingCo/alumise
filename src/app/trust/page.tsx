    ...
    <div className="bg-white min-h-screen">
      ...
      <section className="bg-alumise-obsidian pt-40 pb-24 text-white">
        <div className="container mx-auto px-4 max-w-7xl">
          <h1 className="text-5xl md:text-7xl font-bold uppercase mb-8 tracking-tighter">
            Technical & <span className="text-alumise-gold">Trust Hub.</span>
          </h1>
            ...
            {accreditations.map((acc, idx) => (
              ...
              >
                <div className="w-20 h-20 bg-gray-50 rounded-full flex items-center justify-center mx-auto mb-6">
                  <Award className="w-10 h-10 text-alumise-gold" />
                </div>
      ...
      <section className="py-32 bg-gray-50">
        <div className="container mx-auto px-4 max-w-7xl grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          <div>
            <h2 className="text-sm font-bold uppercase tracking-[0.3em] text-alumise-gold mb-6">The Alumise Guarantee</h2>
            <p className="text-4xl md:text-5xl font-bold uppercase leading-tight tracking-tight mb-8">
              A Decade of Absolute <span className="text-alumise-gold">Confidence.</span>
            </p>
            ...
            <div className="space-y-4">
              <div className="flex items-start">
                <CheckCircle2 className="w-5 h-5 mr-4 text-alumise-gold flex-shrink-0" />
                <div>
          ...
          <div className="bg-alumise-obsidian p-12 text-white relative overflow-hidden">
            ...
            <div className="space-y-4 relative z-10">
              <button className="flex items-center justify-between w-full bg-white/5 border border-white/10 p-5 hover:bg-white/10 transition-all group">
                <span className="flex items-center text-xs font-bold uppercase tracking-widest"><FileText className="w-4 h-4 mr-4 text-alumise-gold" /> Warranty Terms & Conditions</span>
                <span className="text-[8px] opacity-40 group-hover:opacity-100 uppercase tracking-[0.2em]">PDF (1.2MB)</span>
              </button>
              <button className="flex items-center justify-between w-full bg-white/5 border border-white/10 p-5 hover:bg-white/10 transition-all group">
                <span className="flex items-center text-xs font-bold uppercase tracking-widest"><Zap className="w-4 h-4 mr-4 text-alumise-gold" /> Thermal Performance Guide</span>
                <span className="text-[8px] opacity-40 group-hover:opacity-100 uppercase tracking-[0.2em]">PDF (2.4MB)</span>
              </button>
              <button className="flex items-center justify-between w-full bg-white/5 border border-white/10 p-5 hover:bg-white/10 transition-all group">
                <span className="flex items-center text-xs font-bold uppercase tracking-widest"><Lock className="w-4 h-4 mr-4 text-alumise-gold" /> Security & Safety Specs</span>
      ...
      <section className="py-32">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-20">
            <h2 className="text-sm font-bold uppercase tracking-[0.3em] text-alumise-gold mb-6">Performance & Sustainability</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-10 border border-gray-100 bg-white shadow-sm hover:shadow-xl transition-all">
              <Zap className="w-8 h-8 text-alumise-gold mb-8" />
            ...
            <div className="p-10 border border-gray-100 bg-white shadow-sm hover:shadow-xl transition-all">
              <Lock className="w-8 h-8 text-alumise-gold mb-8" />
            ...
            <div className="p-10 border border-gray-100 bg-white shadow-sm hover:shadow-xl transition-all">
              <Leaf className="w-8 h-8 text-alumise-gold mb-8" />
      ...
      {/* Final CTA */}
      <section className="bg-alumise-obsidian py-32 text-white">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          <h2 className="text-4xl md:text-5xl font-bold uppercase mb-8 tracking-tighter">
            Need Detailed <span className="text-alumise-gold">Technical Specs?</span>
          </h2>
          ...
          <Link 
            href="/quote" 
            className="inline-block bg-alumise-gold text-white hover:bg-white hover:text-alumise-obsidian px-10 py-5 rounded-sm font-bold uppercase tracking-widest text-xs transition-all"
          >
