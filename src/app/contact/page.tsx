      ...
      <section className="bg-brand-charcoal pt-40 pb-24 text-white">
        <div className="container mx-auto px-4 max-w-7xl">
          <h1 className="text-5xl md:text-8xl font-bold uppercase mb-8 tracking-tighter">
            Direct <span className="text-brand-gold">Engagement.</span>
          </h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-16">
            ...
            <div className="lg:col-span-1 space-y-12">
              <div className="space-y-8">
                <h3 className="text-xs font-bold uppercase tracking-[0.3em] text-brand-gold">Departmental Contacts</h3>
                
                <div className="space-y-6">
                  <div className="group">
                    <p className="text-[10px] uppercase tracking-widest font-bold text-gray-500 mb-2 group-hover:text-brand-gold transition-colors">Project Estimations</p>
                    <p className="text-xl font-bold mb-1">Email us</p>
                    <p className="text-sm text-gray-500 font-light">info@alumise.co.uk</p>
                  </div>
                  
                  <div className="group">
                    <p className="text-[10px] uppercase tracking-widest font-bold text-gray-500 mb-2 group-hover:text-brand-gold transition-colors">Technical & Engineering</p>
                    <p className="text-xl font-bold mb-1">Email us</p>
                    <p className="text-sm text-gray-500 font-light">info@alumise.co.uk</p>
                  </div>

                  <div className="group">
                    <p className="text-[10px] uppercase tracking-widest font-bold text-gray-500 mb-2 group-hover:text-brand-gold transition-colors">Post-Installation Support</p>
                    <p className="text-xl font-bold mb-1">Email us</p>
                    <p className="text-sm text-gray-500 font-light">info@alumise.co.uk</p>
                  </div>
                </div>
              ...
              <div className="pt-12 border-t border-gray-100 space-y-8">
                <h3 className="text-xs font-bold uppercase tracking-[0.3em] text-brand-gold">Visit Our Facility</h3>
                ...
                <div className="flex items-start">
                  <Clock className="w-5 h-5 mr-4 text-brand-gold flex-shrink-0" />
                  <p className="text-sm text-gray-500 font-light leading-relaxed">
                    Monday — Friday<br />
                    08:00 — 17:00
                  </p>
              ...
              <div className="bg-gray-50 p-12 rounded-sm shadow-inner">
                ...
                <form className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="space-y-2">
                    ...
                    <input type="text" className="w-full bg-white border border-gray-100 p-4 outline-none focus:border-brand-gold transition-all text-sm" />
                  </div>
                  <div className="space-y-2">
                    <label className="text-[10px] uppercase font-bold tracking-widest text-gray-400">Email Address</label>
                    <input type="email" className="w-full bg-white border border-gray-100 p-4 outline-none focus:border-brand-gold transition-all text-sm" />
                  </div>
                  <div className="space-y-2 md:col-span-2">
                    <label className="text-[10px] uppercase font-bold tracking-widest text-gray-400">Subject</label>
                    <select className="w-full bg-white border border-gray-100 p-4 outline-none focus:border-brand-gold transition-all text-sm appearance-none">
                  ...
                  <div className="space-y-2 md:col-span-2">
                    ...
                    <textarea rows={6} className="w-full bg-white border border-gray-100 p-4 outline-none focus:border-brand-gold transition-all text-sm"></textarea>
                  </div>
                  <div className="md:col-span-2 pt-4">
                    <button className="flex items-center bg-brand-charcoal text-white px-12 py-5 rounded-sm font-bold uppercase tracking-widest text-xs hover:bg-brand-gold transition-all shadow-xl group">
