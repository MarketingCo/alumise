          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-16">
            ...
            <div className="lg:col-span-1 space-y-12">
              <div className="space-y-8">
                <h3 className="text-xs font-bold uppercase tracking-[0.3em] text-brand-blue">Departmental Contacts</h3>
              ...
              <div className="pt-12 border-t border-gray-100 space-y-8">
                <h3 className="text-xs font-bold uppercase tracking-[0.3em] text-brand-blue">Visit Our Facility</h3>
                ...
                <div className="flex items-start">
                  <Clock className="w-5 h-5 mr-4 text-brand-blue flex-shrink-0" />
                  <p className="text-sm text-gray-500 font-light leading-relaxed">
                    Monday — Friday<br />
                    08:00 — 17:00
                  </p>
              ...
              <div className="bg-gray-50 p-12 rounded-sm shadow-inner">
                ...
                <form className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="space-y-2">
                    ...
                    <input type="text" className="w-full bg-white border border-gray-100 p-4 outline-none focus:border-brand-blue transition-all text-sm" />
                  </div>
                  <div className="space-y-2">
                    <label className="text-[10px] uppercase font-bold tracking-widest text-gray-400">Email Address</label>
                    <input type="email" className="w-full bg-white border border-gray-100 p-4 outline-none focus:border-brand-blue transition-all text-sm" />
                  </div>
                  <div className="space-y-2 md:col-span-2">
                    <label className="text-[10px] uppercase font-bold tracking-widest text-gray-400">Subject</label>
                    <select className="w-full bg-white border border-gray-100 p-4 outline-none focus:border-brand-blue transition-all text-sm appearance-none">
