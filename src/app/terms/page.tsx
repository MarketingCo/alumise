    ...
    <div className="bg-white min-h-screen pt-40 pb-20">
      <div className="container mx-auto px-4 max-w-4xl">
        <h1 className="text-4xl md:text-6xl font-bold uppercase mb-12 tracking-tighter">
          Terms of <span className="text-alumise-gold">Service.</span>
        </h1>
        
        <div className="prose prose-slate max-w-none font-light leading-relaxed text-gray-500 space-y-8">
          <section>
            <h2 className="text-xl font-bold uppercase text-alumise-obsidian mb-4">1. Project Estimates</h2>
          ...
          <section>
            <h2 className="text-xl font-bold uppercase text-alumise-obsidian mb-4">2. Technical Information</h2>
          ...
          <section>
            <h2 className="text-xl font-bold uppercase text-alumise-obsidian mb-4">3. Intellectual Property</h2>
          ...
          <section>
            <h2 className="text-xl font-bold uppercase text-alumise-obsidian mb-4">4. Governing Law</h2>
