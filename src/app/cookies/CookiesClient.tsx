    ...
    <div className="bg-white min-h-screen pt-40 pb-20">
      <div className="container mx-auto px-4 max-w-4xl">
        <h1 className="text-4xl md:text-6xl font-bold uppercase mb-12 tracking-tighter">
          Cookie <span className="text-alumise-gold">Policy.</span>
        </h1>
        
        <div className="prose prose-slate max-w-none font-light leading-relaxed text-gray-500 space-y-8">
          <section>
            <h2 className="text-xl font-bold uppercase text-alumise-obsidian mb-4">1. What are Cookies?</h2>
          ...
          <section>
            <h2 className="text-xl font-bold uppercase text-alumise-obsidian mb-4">2. How We Use Cookies</h2>
          ...
          <section>
            <h2 className="text-xl font-bold uppercase text-alumise-obsidian mb-4">3. Managing Your Preferences</h2>
