      ...
      <div className="container mx-auto px-4 max-w-7xl">
        <header className="mb-20 text-center max-w-3xl mx-auto">
          <h1 className="text-5xl md:text-7xl font-bold uppercase mb-8 tracking-tighter">
            Architectural <span className="text-alumise-gold">Insights.</span>
          </h1>
            ...
            >
              <Link href={`/blog/${post.slug}`} className="relative h-64 overflow-hidden bg-gray-100">
                ...
                <div className="absolute top-4 left-4">
                  <span className="bg-alumise-gold text-white text-[8px] uppercase tracking-widest font-bold px-3 py-1">
                    {post.category}
                  </span>
                </div>
              </Link>
              <div className="p-8 flex-grow flex flex-col">
                ...
                <h3 className="text-2xl font-bold uppercase tracking-tight mb-4 group-hover:text-alumise-gold transition-colors leading-tight">
                  {post.title}
                </h3>
                ...
                <Link 
                  href={`/blog/${post.slug}`}
                  className="mt-auto inline-flex items-center text-[10px] uppercase tracking-widest font-bold border-b-2 border-alumise-obsidian pb-1 group-hover:border-alumise-gold transition-all w-max"
                >
