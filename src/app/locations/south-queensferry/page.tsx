...
export default function LocationPage() {
  const name = "South Queensferry";
  const slug = "south-queensferry";
    ...
    <div className="bg-white min-h-screen">
      ...
      <section className="bg-brand-charcoal pt-40 pb-24 text-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 max-w-7xl relative z-10">
          <Link href="/locations" className="inline-flex items-center text-[10px] uppercase tracking-widest font-bold text-brand-blue mb-8 hover:text-white transition-colors">
        ...
        <div className="container mx-auto px-4 max-w-7xl grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          <div className="space-y-12">
            ...
            <p className="text-lg text-gray-500 font-light leading-relaxed">
              In {name}, Alumise delivers a level of architectural precision that bridges the gap between concept and reality. We manufacture in-house to ensure absolute quality control.
            </p>
          ...
          <div className="relative h-[500px] bg-gray-100">
            <Image src="https://images.unsplash.com/photo-1507679799987-c73779587ccf?q=80&w=2071&auto=format&fit=crop" alt={`Local Projects in ${name}`} fill className="object-cover grayscale hover:grayscale-0 transition-all duration-700" />
          </div>
        </div>
      </section>
      <section className="py-40 bg-white text-center">
        <div className="container mx-auto px-4 max-w-3xl">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            <Link href="/quote" className="bg-brand-charcoal text-white hover:bg-brand-blue px-10 py-5 rounded-sm font-bold uppercase tracking-widest text-xs transition-all shadow-xl">
              Start Your Project
            </Link>
          </div>
        </div>
