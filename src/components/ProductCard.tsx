  ...
  return (
    ...
    >
      ...
      <div className="p-8">
        ...
        <h3 className="text-2xl font-bold uppercase mb-4 tracking-tight group-hover:text-brand-blue transition-colors">
          {product.title}
        </h3>
        ...
        <Link 
          ...
          className="inline-flex items-center text-[10px] uppercase tracking-[0.2em] font-bold border-b-2 border-brand-charcoal pb-1 group-hover:border-brand-blue group-hover:text-brand-blue transition-all"
        >
