          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8">
              ...
              <h2 className="text-4xl md:text-5xl font-bold text-white leading-none tracking-tight" style={{ fontFamily: 'var(--font-oswald)' }}>
                Download the 2026<br /><span className="text-brand-gold">Specifiers Guide</span>
              </h2>
              <p className="text-lg text-brand-silver leading-relaxed max-w-md">
              ...
              <ul className="space-y-3">
                {['U-Value Comparison Matrix', 'Security Rating Guide', 'Scottish Building Standards Overview'].map((item) => (
                  <li key={item} className="flex items-center text-xs text-brand-silver font-bold uppercase tracking-widest">
                    <span className="w-1.5 h-1.5 bg-brand-gold rounded-full mr-3" /> {item}
                  </li>
                ))}
              </ul>
            </div>
            ...
            <div className="text-center lg:text-left">
              ...
              <Link
                href="/contact"
                className="inline-flex items-center gap-3 bg-brand-gold text-brand-charcoal px-8 py-5 font-bold uppercase tracking-widest text-xs hover:bg-brand-gold-light transition-colors"
              >
